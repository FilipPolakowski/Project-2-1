...
public class HelloApplication extends Application {
    ...
    private ImageView[] deck = new ImageView[40];
    ...
    private void initGame(Stage stage) throws MalformedURLException, FileNotFoundException {
        EventHandler<javafx.scene.input.MouseEvent> eh1 = new EventHandler<javafx.scene.input.MouseEvent>() {
            ...
            public void handle(javafx.scene.input.MouseEvent event) {
                ...
                for(int i = 0; i < 3; i++) {
                    try {
                        iv[i].setImage(Card.getImage(g.players.get(g.currentPlayer).getHand().get(i)));
        ...
        EventHandler<javafx.scene.input.MouseEvent> eh2 = new EventHandler<javafx.scene.input.MouseEvent>() {
            ...
            public void handle(javafx.scene.input.MouseEvent event) {
                try {
                    iv[3].setImage(Card.getImage(g.players.get(g.currentPlayer).getHand().get(1)));
                } catch (FileNotFoundException| IndexOutOfBoundsException  | MalformedURLException e) {
                    e.printStackTrace();
                }
                iv[3].setVisible(true);
        ...
        EventHandler<javafx.scene.input.MouseEvent> eh3 = new EventHandler<javafx.scene.input.MouseEvent>() {
            ...
            public void handle(javafx.scene.input.MouseEvent event) {
                try {
                    iv[3].setImage(Card.getImage(g.players.get(g.currentPlayer).getHand().get(2)));
                } catch (FileNotFoundException | IndexOutOfBoundsException | MalformedURLException e) {
                    //e.printStackTrace();
                }
                iv[3].setVisible(true);
                ...
                for (int i = g.deck.size()+1; i < 40; i++) {
                    if(g.deck.isEmpty()){
                        deck[0].setVisible(false);
                    }
                    if (!deck[i].isVisible()) {
        ...
        deck[0] = new ImageView(imageForFile);
        deck[0].setFitWidth(120);
        deck[0].setFitHeight(200);
        deck[0].setRotate(-90);
        deck[0].setX(330);
        deck[0].setY(80);

        deck[0].setPreserveRatio(true);

        deck[0].setVisible(true);

        for (int i = 1; i < deck.length; i++) {

            deck[i] = new ImageView(new Image(userHome+"/PNG-cards-1.3/CardBack1.JPG"));
            deck[i].setFitWidth(120);
            deck[i].setFitHeight(200);

            deck[i].setX(330+i);
            deck[i].setY(80-i);

            deck[i].setPreserveRatio(true);

            deck[i].setVisible(true);
        }
        iv[3] = new ImageView(Card.getImage(g.players.get(g.currentPlayer).getHand().get(0)));
        iv[3].setX(180);
        iv[3].setY(60);
        ...
        iv[3].setVisible(false);
        iv[0] = new ImageView(Card.getImage(g.players.get(g.currentPlayer).getHand().get(0)));
        iv[0].setX(30);
        iv[0].setY(250);
        ...
        iv[1] = new ImageView(Card.getImage(g.players.get(g.currentPlayer).getHand().get(1)));
        iv[1].setX(180);
        iv[1].setY(250);
        ...
        iv[2] = new ImageView(Card.getImage(g.players.get(g.currentPlayer).getHand().get(2)));
        iv[2].setX(330);
        iv[2].setY(250);
