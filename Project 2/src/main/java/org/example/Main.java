...
public class Main extends Application {
    public void start(Stage stage) throws IOException {
        ...
        g.startRound();
       // while (true) {
            iv1 = new ImageView(Card.getImage(g.players.get(g.currentPlayer).getHand().get(0)));
            iv1.setX(30);
            iv1.setY(250);
            iv1.setFitHeight(200);
            iv1.setFitWidth(120);
            iv1.setPreserveRatio(true);
            iv2 = new ImageView(Card.getImage(g.players.get(g.currentPlayer).getHand().get(1)));
            iv2.setX(180);
            iv2.setY(250);
            iv2.setFitHeight(200);
            iv2.setFitWidth(120);
            iv2.setPreserveRatio(true);
            iv3 = new ImageView(Card.getImage(g.players.get(g.currentPlayer).getHand().get(2)));
            iv3.setX(330);
            iv3.setY(250);
